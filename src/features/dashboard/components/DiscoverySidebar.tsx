...
export const DiscoverySidebar: React.FC<DiscoverySidebarProps> = ({
    ...
    return (
        <div className={cn("h-full bg-white border-r border-slate-200 z-[100] flex flex-col relative shadow-2xl transition-all duration-300", isOpen ? "w-[340px]" : "w-0 overflow-hidden")}>
